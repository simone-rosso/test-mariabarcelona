    ...
    ButtonDefaultExample.prototype.render = function () {
        ...
        return (React.createElement("div", { className: office_ui_fabric_react_1.css(classNames.twoup) },
            React.createElement("div", null,
                ...
                React.createElement(office_ui_fabric_react_1.DefaultButton, { "data-automation-id": "test", allowDisabledFocus: true, disabled: disabled, checked: checked, text: "Standard Button", onClick: this._alertClicked })),
            React.createElement("div", null,
                React.createElement(office_ui_fabric_react_1.Label, null, "Primary"),
                React.createElement(office_ui_fabric_react_1.PrimaryButton, { "data-automation-id": "test", disabled: disabled, checked: checked, text: "Primary Button", onClick: this._alertClicked, allowDisabledFocus: true }))));
    };
