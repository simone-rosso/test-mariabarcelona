...
var CheckboxBase = /** @class */ (function (_super) {
    ...
    CheckboxBase.getDerivedStateFromProps = function (props, state) {
        if (props.checked !== undefined) {
            return tslib_1.__assign({}, state, { isChecked: !!props.checked });
        }
        return state;
    };
    /**
    ...
    CheckboxBase.prototype.render = function () {
        ...
        return (React.createElement(KeytipData_1.KeytipData, { keytipProps: keytipProps, disabled: disabled }, function (keytipAttributes) { return (React.createElement("div", { className: _this._classNames.root },
