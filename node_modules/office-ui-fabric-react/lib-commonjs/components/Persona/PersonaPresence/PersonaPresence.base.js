...
var PersonaPresenceBase = /** @class */ (function (_super) {
    ...
    function PersonaPresenceBase(props) {
        ...
        _this._onRenderIcon = function (className, style) { return (React.createElement(Icon_1.Icon, { className: className, iconName: determineIcon(_this.props.presence, _this.props.isOutOfOffice), style: style })); };
        return _this;
    }
