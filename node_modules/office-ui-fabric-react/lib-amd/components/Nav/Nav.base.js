define(["require", "exports", "tslib", "react", "../../Button", "./Nav.styles", "../../Utilities", "../../FocusZone", "../../Icon"], function (require, exports, tslib_1, React, Button_1, Nav_styles_1, Utilities_1, FocusZone_1, Icon_1) {
    "use strict";
    ...
    var NavBase = /** @class */ (function (_super) {
        ...
        NavBase.prototype._renderNavLink = function (link, linkIndex, nestingLevel) {
            var _a = this.props, styles = _a.styles, groups = _a.groups, theme = _a.theme, _b = _a.onRenderLink, onRenderLink = _b === void 0 ? this._onRenderLink : _b, _c = _a.linkAs, LinkAs = _c === void 0 ? Button_1.ActionButton : _c, selectedAriaLabel = _a.selectedAriaLabel;
