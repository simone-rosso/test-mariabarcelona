        ...
        FacepileBasicExample.prototype.render = function () {
            ...
            return (React.createElement("div", { className: "ms-FacepileExample" },
                ...
                React.createElement("div", { className: "control" },
                    ...
                    React.createElement(Checkbox_1.Checkbox, { styles: { root: { margin: '10px 0' } }, label: "Fade In", checked: this.state.imagesFadeIn, onChange: this._onChangeFadeIn }))));
        };
