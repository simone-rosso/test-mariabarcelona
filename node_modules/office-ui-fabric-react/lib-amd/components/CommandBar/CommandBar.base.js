define(["require", "exports", "tslib", "react", "../../Utilities", "../../OverflowSet", "../../ResizeGroup", "../../FocusZone", "../../Utilities", "../../Button", "../../Tooltip"], function (require, exports, tslib_1, React, Utilities_1, OverflowSet_1, ResizeGroup_1, FocusZone_1, Utilities_2, Button_1, Tooltip_1) {
    "use strict";
    ...
    var CommandBarBase = /** @class */ (function (_super) {
        ...
        function CommandBarBase() {
            ...
            _this._commandButton = function (item, props) {
                if (_this.props.buttonAs) {
                    ...
                    return React.createElement(Type, tslib_1.__assign({}, props, { defaultRender: Button_1.CommandBarButton }));
                }
                if (item.commandBarButtonAs) {
                    var Type = item.commandBarButtonAs;
                    return React.createElement(Type, tslib_1.__assign({}, props));
                }
                return React.createElement(Button_1.CommandBarButton, tslib_1.__assign({}, props, { defaultRender: Button_1.CommandBarButton }));
            };
        ...
        CommandBarBase.prototype.render = function () {
            var _a = this.props, className = _a.className, items = _a.items, overflowItems = _a.overflowItems, farItems = _a.farItems, styles = _a.styles, theme = _a.theme, dataDidRender = _a.dataDidRender, _b = _a.onReduceData, onReduceData = _b === void 0 ? this._onReduceData : _b, _c = _a.onGrowData, onGrowData = _c === void 0 ? this._onGrowData : _c;
            var commandBarData = {
            ...
            return (React.createElement(ResizeGroup_1.ResizeGroup, { componentRef: this._resizeGroup, className: className, data: commandBarData, onReduceData: onReduceData, onGrowData: onGrowData, onRenderData: this._onRenderData, dataDidRender: dataDidRender }));
        };
