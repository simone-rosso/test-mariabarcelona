define(["require", "exports", "tslib", "react", "../../Utilities", "../../Icon", "../../common/DirectionalHint", "../../ContextualMenu", "./BaseButton.classNames", "./SplitButton/SplitButton.classNames", "../../KeytipData", "@uifabric/utilities"], function (require, exports, tslib_1, React, Utilities_1, Icon_1, DirectionalHint_1, ContextualMenu_1, BaseButton_classNames_1, SplitButton_classNames_1, KeytipData_1, utilities_1) {
    "use strict";
    ...
    var BaseButton = /** @class */ (function (_super) {
        ...
        function BaseButton(props, rootClassName) {
            ...
            _this._getMemoizedMenuButtonKeytipProps = utilities_1.memoizeFunction(function (keytipProps) {
                return tslib_1.__assign({}, keytipProps, { hasMenu: true });
            });
            _this._onRenderIcon = function (buttonProps, defaultRender) {
                var iconProps = _this.props.iconProps;
                if (iconProps && (iconProps.iconName !== undefined || iconProps.imageProps)) {
                    var className = iconProps.className, rest = tslib_1.__rest(iconProps, ["className"]);
                    return React.createElement(Icon_1.Icon, tslib_1.__assign({ className: Utilities_1.css(_this._classNames.icon, className) }, rest));
                }
                return null;
            };
        ...
        BaseButton.prototype.render = function () {
            ...
            this._classNames = getClassNames
                ...
                : BaseButton_classNames_1.getBaseButtonClassNames(theme, styles, className, variantClassName, iconProps && iconProps.className, menuIconProps && menuIconProps.className, isPrimaryButtonDisabled, checked, this._isExpanded, this.props.split);
        ...
        BaseButton.prototype._onRenderSplitButtonContent = function (tag, buttonProps) {
            ...
            var classNames = getSplitButtonClassNames
                ...
                : styles && SplitButton_classNames_1.getClassNames(styles, !!disabled, this._isExpanded, !!checked, !!primaryDisabled);
            Utilities_1.assign(buttonProps, {
                onClick: undefined,
                tabIndex: -1,
        ...
        BaseButton.prototype._onRenderSplitButtonMenuButton = function (classNames, keytipAttributes) {
            var _a = this.props, allowDisabledFocus = _a.allowDisabledFocus, checked = _a.checked, disabled = _a.disabled, splitButtonMenuProps = _a.splitButtonMenuProps;
            ...
            var splitButtonProps = tslib_1.__assign({}, splitButtonMenuProps, { styles: classNames, checked: checked, disabled: disabled, allowDisabledFocus: allowDisabledFocus, onClick: this._onMenuClick, menuProps: undefined, iconProps: tslib_1.__assign({}, menuIconProps, { className: this._classNames.menuIcon }), ariaLabel: splitButtonAriaLabel, 'aria-haspopup': true, 'aria-expanded': this._isExpanded, 'data-is-focusable': false });
