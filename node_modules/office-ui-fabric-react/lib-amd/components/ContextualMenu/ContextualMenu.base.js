define(["require", "exports", "tslib", "react", "./ContextualMenu.types", "../../common/DirectionalHint", "../../FocusZone", "../../Utilities", "../../Utilities", "../../utilities/contextualMenu/index", "../../utilities/decorators/withResponsiveMode", "../../Callout", "./ContextualMenuItem", "./ContextualMenuItemWrapper/index", "../../Styling", "./ContextualMenu.classNames"], function (require, exports, tslib_1, React, ContextualMenu_types_1, DirectionalHint_1, FocusZone_1, Utilities_1, Utilities_2, index_1, withResponsiveMode_1, Callout_1, ContextualMenuItem_1, index_2, Styling_1, ContextualMenu_classNames_1) {
    "use strict";
        ...
        ContextualMenuBase.prototype._setTargetWindowAndElement = function (target) {
            if (target) {
                if (typeof target === 'string') {
                    ...
                    this._targetWindow = Utilities_2.getWindow(this._target);
                }
                else {
