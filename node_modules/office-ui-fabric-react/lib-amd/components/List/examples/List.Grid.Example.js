define(["require", "exports", "tslib", "react", "office-ui-fabric-react/lib/FocusZone", "office-ui-fabric-react/lib/List", "@uifabric/styling"], function (require, exports, tslib_1, React, FocusZone_1, List_1, styling_1) {
    "use strict";
    ...
    var ListGridExample = /** @class */ (function (_super) {
        ...
        ListGridExample.prototype.render = function () {
            return (React.createElement(FocusZone_1.FocusZone, null,
                React.createElement(List_1.List, { className: classNames.listGridExample, items: this.props.items, getItemCountForPage: this._getItemCountForPage, getPageHeight: this._getPageHeight, renderedWindowsAhead: 4, onRenderCell: this._onRenderCell })));
        };
