define(["require", "exports", "tslib", "react", "office-ui-fabric-react/lib/Persona", "office-ui-fabric-react/lib/Stack", "../../../common/TestImages", "office-ui-fabric-react/lib/Styling"], function (require, exports, tslib_1, React, Persona_1, Stack_1, TestImages_1, Styling_1) {
    "use strict";
    ...
    exports.PersonaCustomCoinRenderExample = function () {
        return (React.createElement(Stack_1.Stack, { tokens: { childrenGap: 10 } },
            ...
            React.createElement(Persona_1.Persona, tslib_1.__assign({}, examplePersona, { size: Persona_1.PersonaSize.size72, presence: Persona_1.PersonaPresence.online, onRenderCoin: _onRenderCoin, imageAlt: "Custom Coin Image", imageUrl: TestImages_1.TestImages.personaMale, coinSize: 72 }))));
    };
