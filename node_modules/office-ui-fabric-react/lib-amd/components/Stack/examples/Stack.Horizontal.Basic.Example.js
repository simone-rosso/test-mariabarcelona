    ...
    var HorizontalStackBasicExample = /** @class */ (function (_super) {
        ...
        HorizontalStackBasicExample.prototype.render = function () {
            return (React.createElement(office_ui_fabric_react_1.Stack, { tokens: containerStackTokens },
                ...
                React.createElement(office_ui_fabric_react_1.Stack, { horizontal: true, disableShrink: true, styles: stackStyles },
                ...
                React.createElement(office_ui_fabric_react_1.Stack, { horizontal: true, disableShrink: true, styles: stackStyles, tokens: horizontalGapStackTokens },
                    React.createElement("span", null, "Item One"),
                    React.createElement("span", null, "Item Two"),
                    React.createElement("span", null, "Item Three")),
                React.createElement("span", null, "Item alignments"),
                React.createElement(office_ui_fabric_react_1.Stack, { horizontal: true, disableShrink: true, styles: itemAlignmentsStackStyles, tokens: itemAlignmentsStackTokens },
                ...
                React.createElement(office_ui_fabric_react_1.Stack, { horizontal: true, disableShrink: true, onClick: this._onClick, styles: stackStyles, tokens: clickableStackTokens },
