define(["require", "exports", "../../Styling", "../../Styling"], function (require, exports, Styling_1, Styling_2) {
    "use strict";
    ...
    function getStyles(props) {
        ...
        var classNames = Styling_2.getGlobalClassNames(GlobalClassNames, theme);
        ...
        return {
            ...
            field: [
                classNames.field,
                Styling_1.normalize,
                Styling_2.getPlaceholderStyles(placeholderStyles),
                {
                    backgroundColor: 'transparent',
                    border: 'none',
                    outline: 'none',
