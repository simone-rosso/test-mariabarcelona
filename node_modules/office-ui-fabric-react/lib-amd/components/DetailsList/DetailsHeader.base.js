define(["require", "exports", "tslib", "react", "react-dom", "../../Utilities", "./DetailsList.types", "../../FocusZone", "../../Icon", "../../Layer", "../GroupedList/GroupSpacer", "../../GroupedList", "./DetailsRowCheck", "../../utilities/selection/interfaces", "../../utilities/dragdrop/index", "../../components/DetailsList/DetailsColumn", "./DetailsHeader.types", "../../Utilities"], function (require, exports, tslib_1, React, react_dom_1, Utilities_1, DetailsList_types_1, FocusZone_1, Icon_1, Layer_1, GroupSpacer_1, GroupedList_1, DetailsRowCheck_1, interfaces_1, index_1, DetailsColumn_1, DetailsHeader_types_1, Utilities_2) {
    "use strict";
    ...
    var DetailsHeaderBase = /** @class */ (function (_super) {
        ...
        DetailsHeaderBase.prototype.render = function () {
            ...
            return (React.createElement(FocusZone_1.FocusZone, { role: "row", "aria-label": ariaLabel, className: classNames.root, componentRef: this._rootComponent, ref: this._onRootRef, onMouseMove: this._onRootMouseMove, "data-automationid": "DetailsHeader", style: { minWidth: rowWidth }, direction: FocusZone_1.FocusZoneDirection.horizontal },
                showCheckbox
                    ? [
                        React.createElement("div", { key: "__checkbox", className: classNames.cellIsCheck, "aria-labelledby": this._id + "-check", onClick: !isCheckboxHidden ? this._onSelectAllClicked : undefined, "aria-colindex": 1, role: 'columnheader' }, onRenderColumnHeaderTooltip({
                            ...
                            children: (React.createElement(DetailsRowCheck_1.DetailsRowCheck, { id: this._id + "-check", "aria-label": ariaLabelForSelectionColumn, "aria-describedby": !isCheckboxHidden
                                    ...
                                    : ariaLabelForSelectionColumn && !this.props.onRenderColumnHeaderTooltip
                                        ? this._id + "-checkTooltip"
                                        : undefined, "data-is-focusable": !isCheckboxHidden || undefined, isHeader: true, selected: isAllSelected, anySelected: false, canSelect: !isCheckboxHidden, className: classNames.check, onRenderDetailsCheckbox: onRenderDetailsCheckbox }))
                ...
                groupNestingDepth > 0 && this.props.collapseAllVisibility === GroupedList_1.CollapseAllVisibility.visible ? (React.createElement("div", { className: classNames.cellIsGroupExpander, onClick: this._onToggleCollapseAll, "data-is-focusable": true, "aria-label": ariaLabelForToggleAllGroupsButton, "aria-expanded": !isAllCollapsed, role: ariaLabelForToggleAllGroupsButton ? 'button' : undefined },
                    React.createElement(Icon_1.Icon, { className: classNames.collapseButton, iconName: isRTL ? 'ChevronLeftMed' : 'ChevronRightMed' }))) : null,
                ...
                columns.map(function (column, columnIndex) {
                    ...
                    return [
                        ...
                        React.createElement(DetailsColumn_1.DetailsColumn, { column: column, key: column.key, columnIndex: (showCheckbox ? 2 : 1) + columnIndex, parentId: _this._id, isDraggable: _isDraggable, updateDragInfo: _this._updateDragInfo, dragDropHelper: _this._dragDropHelper, onColumnClick: onColumnClick, onColumnContextMenu: onColumnContextMenu, 
        ...
        DetailsHeaderBase.prototype._getColumnReorderProps = function () {
            ...
            return columnReorderProps || (columnReorderOptions && tslib_1.__assign({}, columnReorderOptions, { onColumnDragEnd: undefined }));
        };
        ...
        DetailsHeaderBase.prototype._renderDropHint = function (dropHintIndex) {
            ...
            return (React.createElement("div", { key: 'dropHintKey', className: classNames.dropHintStyle, id: "columnDropHint_" + dropHintIndex },
                React.createElement(Icon_1.Icon, { key: "dropHintCaretKey", "aria-hidden": true, "data-is-focusable": false, "data-sizer-index": dropHintIndex, className: classNames.dropHintCaretStyle, iconName: 'CaretUpSolid8' }),
    ...
    function _liesBetween(target, left, right) {
        return Utilities_1.getRTL() ? target <= left && target >= right : target >= left && target <= right;
    }
    function _isBefore(a, b) {
        return Utilities_1.getRTL() ? a >= b : a <= b;
    }
