define(["require", "exports", "tslib", "react", "office-ui-fabric-react/lib/Link", "office-ui-fabric-react/lib/TextField", "office-ui-fabric-react/lib/CommandBar", "office-ui-fabric-react/lib/ContextualMenu", "office-ui-fabric-react/lib/DetailsList", "office-ui-fabric-react/lib/utilities/exampleData", "office-ui-fabric-react/lib/Utilities", "office-ui-fabric-react/lib/Styling"], function (require, exports, tslib_1, React, Link_1, TextField_1, CommandBar_1, ContextualMenu_1, DetailsList_1, exampleData_1, Utilities_1, Styling_1) {
    "use strict";
    var _a;
    ...
    var DetailsListAdvancedExample = /** @class */ (function (_super) {
        ...
        function DetailsListAdvancedExample(props) {
            ...
            _this._allItems = exampleData_1.createListItems(ITEMS_COUNT);
        ...
        DetailsListAdvancedExample.prototype.render = function () {
            ...
            return (React.createElement("div", { className: rootClass },
                React.createElement(CommandBar_1.CommandBar, { styles: { root: { marginBottom: '40px' } }, items: this._getCommandItems(canResizeColumns, checkboxVisibility, constrainMode, isHeaderVisible, isLazyLoaded, layoutMode, selectionMode), farItems: [{ key: 'count', text: this.state.selectionCount + " selected" }] }),
