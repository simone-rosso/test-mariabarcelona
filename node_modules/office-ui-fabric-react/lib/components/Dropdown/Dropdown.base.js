...
var DropdownBase = /** @class */ (function (_super) {
    ...
    function DropdownBase(props) {
        ...
        _this._onRenderLabel = function (props) {
            ...
            var labelStyles = _this._classNames.subComponentStyles
                ...
                : undefined;
            return label ? (React.createElement(Label, { className: _this._classNames.label, id: id + '-label', htmlFor: id, required: required, styles: labelStyles, disabled: disabled }, label)) : null;
        };
    ...
    DropdownBase.prototype._renderFocusableList = function (props) {
        ...
        return (React.createElement("div", { className: this._classNames.dropdownItemsWrapper, onKeyDown: this._onZoneKeyDown, onKeyUp: this._onZoneKeyUp, ref: this._host, tabIndex: 0 },
            React.createElement(FocusZone, { ref: this._focusZone, direction: FocusZoneDirection.vertical, id: id + '-list', className: this._classNames.dropdownItems, "aria-label": ariaLabel, "aria-labelledby": label && !ariaLabel ? id + '-label' : undefined, role: "listbox" }, onRenderList(props, this._onRenderList))));
    };
