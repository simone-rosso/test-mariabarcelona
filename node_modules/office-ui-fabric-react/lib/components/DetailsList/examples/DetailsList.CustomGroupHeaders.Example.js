...
var DetailsListCustomGroupHeadersExample = /** @class */ (function (_super) {
        ...
        _this._onRenderGroupHeader = function (props) {
            return (React.createElement("div", { className: classNames.headerAndFooter },
                ...
                React.createElement("div", { className: classNames.headerLinkSet },
                    React.createElement(Link, { className: classNames.headerLink, onClick: _this._onToggleSelectGroup(props) }, props.isSelected ? 'Remove selection' : 'Select group'),
    ...
    DetailsListCustomGroupHeadersExample.prototype._onRenderDetailsHeader = function (props) {
        return React.createElement(DetailsHeader, tslib_1.__assign({}, props, { ariaLabelForToggleAllGroupsButton: 'Toggle selection' }));
    };
