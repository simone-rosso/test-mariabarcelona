    ...
    DetailsListDocumentsExample.prototype.render = function () {
        ...
        return (React.createElement(Fabric, null,
            React.createElement("div", { className: classNames.controlWrapper },
                React.createElement(Toggle, { label: "Enable compact mode", checked: isCompactMode, onChange: this._onChangeCompactMode, onText: "Compact", offText: "Normal", styles: controlStyles }),
                React.createElement(Toggle, { label: "Enable modal selection", checked: isModalSelection, onChange: this._onChangeModalSelection, onText: "Modal", offText: "Normal", styles: controlStyles }),
