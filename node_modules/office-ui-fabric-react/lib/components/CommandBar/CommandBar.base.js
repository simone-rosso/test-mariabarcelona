...
var CommandBarBase = /** @class */ (function (_super) {
    ...
    function CommandBarBase() {
        ...
        _this._onRenderItem = function (item) {
            ...
            if (item.iconOnly && itemText !== undefined) {
                return (React.createElement(TooltipHost, tslib_1.__assign({ content: itemText }, item.tooltipHostProps), _this._commandButton(item, commandButtonProps)));
            }
        ...
        _this._commandButton = function (item, props) {
            if (_this.props.buttonAs) {
                ...
                return React.createElement(Type, tslib_1.__assign({}, props, { defaultRender: CommandBarButton }));
            }
            if (item.commandBarButtonAs) {
                var Type = item.commandBarButtonAs;
                return React.createElement(Type, tslib_1.__assign({}, props));
            }
            return React.createElement(CommandBarButton, tslib_1.__assign({}, props, { defaultRender: CommandBarButton }));
        };
    ...
    CommandBarBase.prototype.render = function () {
        ...
        return (React.createElement(ResizeGroup, { componentRef: this._resizeGroup, className: className, data: commandBarData, onReduceData: onReduceData, onGrowData: onGrowData, onRenderData: this._onRenderData, dataDidRender: dataDidRender }));
    };
